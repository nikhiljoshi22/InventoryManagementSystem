...
$id = $_GET['id'];
			  ...
			  $show_data = "select * from customer_details where id=$id";
              $query_show_data = mysqli_query($db,$show_data);

              $show_field_data = mysqli_fetch_assoc($query_show_data);
...
$update_query = "UPDATE products SET id=$id, prod_name='$prod_name' , quantity='$quantity' , low_lim='$low_lim',price='$price' where id = $id";
...
?>
  ...
  <div class="title">Welcome User</div><br>
  <div class="sub-title">Update the data you want</div>
  <div class="fields">
  ...
  <button class="signin-button" name="submit">UPDATE</button>
  <div class="link">
